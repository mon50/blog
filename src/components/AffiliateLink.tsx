  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden my-8">
      <div className="p-4 bg-gray-50 border-b flex items-center">
        ...
        <span className="font-medium text-gray-700">商品紹介</span>
      </div>
      <div className="md:flex">
        <div className="md:w-1/3 relative h-64 md:h-auto bg-gray-100 flex items-center justify-center">
          {imageUrl ? (
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            ...
            {yahooUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer sponsored"
                className="inline-flex items-center px-4 py-2 bg-red-500 text-white rounded-md font-medium hover:bg-red-600 transition-colors"
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
