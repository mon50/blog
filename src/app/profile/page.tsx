      ...
      <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="md:flex">
            ...
            <div className="p-8 md:p-10 md:w-2/3">
              ...
              <div className="prose max-w-none prose-headings:text-[#2d2926] prose-a:text-[#6f4e37]">
                <p className="text-lg text-[#3c3732] mb-6">はじめまして。</p>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#e2ddd5] p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <span className="w-12 h-12 bg-[#1DA1F2] rounded-full flex items-center justify-center mr-4">
                <svg
              ...
              <div>
                <div className="font-medium text-[#2d2926] group-hover:text-[#6f4e37]">
                  X (Twitter)
                </div>
            ...
            <a
              ...
              className="flex items-center p-4 bg-[#f9f7f5] rounded-md hover:bg-[#f1eeea] transition-colors group"
            >
              <span className="w-12 h-12 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600 rounded-full flex items-center justify-center mr-4">
                <svg
                  className="w-6 h-6 text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
            ...
            <a
              ...
              className="flex items-center p-4 bg-[#f9f7f5] rounded-md hover:bg-[#f1eeea] transition-colors group"
            >
              <span className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mr-4">
                <svg
                  className="w-6 h-6 text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
