        ...
        <article className="bg-white rounded-xl shadow-md overflow-hidden">
          <header className="p-6 md:p-8 border-b">
            ...
            <div className="flex flex-wrap mb-4">
              {frontMatter.tags?.map((tag: string) => (
                <Link 
                  href={`/tag/${tag}`} 
                  key={tag}
                  className="mr-2 mb-2 px-3 py-1 bg-blue-50 text-blue-700 text-sm rounded-full hover:bg-blue-100 transition-colors"
                >
                  {tag}
                </Link>
              ))}
            ...
            <div className="flex items-center mt-6">
              ...
              <div>
                <p className="font-medium text-gray-900">管理人</p>
                <p className="text-sm text-gray-600">ガジェット好きのブロガー</p>
              </div>
            </div>
          </header>
          ...
          {/* シェアボタン */}
          <div className="px-6 md:px-8 pb-6 md:pb-8 pt-2 border-t">
            <div className="flex items-center justify-between">
              <p className="font-medium text-gray-700">この記事をシェア:</p>
              ...
              {relatedPosts.map((post) => (
                ...
                >
                  <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="p-4">
                      <h3 className="text-lg font-medium text-gray-900 group-hover:text-blue-600 transition-colors duration-300 mb-2 line-clamp-2">
